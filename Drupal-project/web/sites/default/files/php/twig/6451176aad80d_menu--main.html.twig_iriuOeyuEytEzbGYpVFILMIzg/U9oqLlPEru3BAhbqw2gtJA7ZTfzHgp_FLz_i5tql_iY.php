...
class __TwigTemplate_7146efe996df9fae3cc22a15f89d191f extends Template
{
    private $source;
    private $macros = [];
...
($context["menu_level"] ?? null) == 0) && twig_get_attribute($this->env, $this->source, $context["item"], "is_expanded", [], "any", false, false, true, 49))) {
  ...
  ";
    ...
    {
        return new Source("", "themes/contrib/zuvi/templates/navigation/menu--main.html.twig", "/var/www/mysite.com/html/Drupal-project/web/themes/contrib/zuvi/templates/navigation/menu--main.html.twig");
    }
